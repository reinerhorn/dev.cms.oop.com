...
//exit;
        ...
        if (empty($postData['agree'])) {
            return [
                'status'   => 'error',
                'message'  => 'AGB und DSGVO müssen akzeptiert werden',
                'redirect' => null,
                'errors'   => [
        ...
        if (
            ...
            empty($postData['password_repeat'])
        ) {
            return [
                'status'   => 'error',
                'message'  => 'E-Mail, Passwort und Passwort-Wiederholung sind erforderlich',
                'redirect' => null,
                'errors'   => [
                    'form' => 'E-Mail, Passwort und Passwort-Wiederholung sind erforderlich'
                ]
            ];
        }

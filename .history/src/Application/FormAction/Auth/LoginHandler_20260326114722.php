...
{
    public static function loadByUuid(\mysqli $db, string $uuid, string $lang): array
    {
        // 🔥 WICHTIG: Dieser Block wird vom ContentController erwartet
        // und sorgt dafür, dass dein Formular korrekt geladen wird

        return [
            'type' => 'forms',
            'template' => 'pages/forms.twig',
            'config' => [
                // 🔥 MUSS exakt zu deiner DB passen!
                'form_id' => 'auth_login_form'
            ]
        ];
    }

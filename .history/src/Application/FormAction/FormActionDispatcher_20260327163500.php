...
use CMS\Core\CMSApp;
use CMS\Application\FormAction\FormActionHandlerInterface;
...

{
    ...
    public static function dispatch(
        ...
        try {
            ...
            // 🔥 Sicherstellen, dass es ein gültiger Handler ist
            if (!$handler instanceof FormActionHandlerInterface) {
                throw new RuntimeException('Handler implementiert kein FormActionHandlerInterface: ' . $handlerClass);
            }

            return $handler->handle($postData, $pageMeta);

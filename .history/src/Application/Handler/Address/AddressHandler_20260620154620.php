...
namespace CMS\Application\Handler\Address;
...
final class AddressHandler implements CrudHandlerInterface
{
    ...
    public function handle(array $postData, array $pageMeta = []): array
    {
        ...
        return match ($action) {
            'address_save'   => $this->handleSave($postData, $id),
            'address_update' => $this->handleUpdate($postData, $id),
            'address_delete' => $this->handleDelete($id),
            'address_cancel' => $this->success(
                'Abgebrochen',
                $this->redirectBack()
            ),
    ...
    public function load(string $id): array
    {
        ...
        if (!$stmt) {
            throw new RuntimeException(
                'Address load prepare fehlgeschlagen: ' . $this->db->error
            );d
        }
    ...
    public function update(string $id, array $data): bool
    {
        ...
        if (!$stmt) {
            throw new RuntimeException(
                'Address update prepare fehlgeschlagen: ' . $this->db->error
            );
        }
        ...
        if (!$success) {
            throw new RuntimeException(
                'Address aktualisieren fehlgeschlagen: ' . $stmt->error
            );
        }
    ...
    public function delete(string $id): bool
    {
        ...
        if (!$stmt) {
            throw new RuntimeException(
                'Address delete prepare fehlgeschlagen: ' . $this->db->error
            );
        }
        ...
        if (!$success) {
            throw new RuntimeException(
                'Address löschen fehlgeschlagen: ' . $stmt->error
            );
        }

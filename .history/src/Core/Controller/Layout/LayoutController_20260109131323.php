 ...
 * - Context-Trennung (frontend | admin)
 */
class LayoutController
{
    ...
    public function getLayout(): array
    {
        ...
        // ---------------------------------
        // Context-Guard (ADMIN ≠ FRONTEND)
        // ---------------------------------
        if (
            $this->context === 'admin'
            && !$roleService->roleHasPermission($this->roleId, 'perm-view-admin')
        ) {
            // Kein Adminrecht → Admin-Layout darf NICHT geladen werden

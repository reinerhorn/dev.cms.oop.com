    ...
    private function loadPluginsForPage(string $pageId): array
    {
        ...
        foreach ($rows as $row) {
            ...
            if (!empty($handlerClass)) {
                ...
                $paths[] = '\\CMS\\Application\\FormAction\\' . $handlerClass;
                $paths[] = '\\CMS\\Plugin\\' . $handlerClass;
                $paths[] = '\\CMS\\Core\\Controller\\Admin\\' . $handlerClass;
                $paths[] = '\\CMS\\Core\\Controller\\Frontend\\' . $handlerClass;
            ...
            if (class_exists($className)) {
                ...
                if (!empty($block)) {
                    $block['type'] = $plugin;
                    $block['uuid'] = $uuid;               // <- plugin_content_uuid korrekt übernehmen
            ...
            $blocks[] = [
                'type'     => $plugin,
                'idx'      => $idx,
                'uuid'     => $uuid,                      // <- plugin_content_uuid auch hier setzen

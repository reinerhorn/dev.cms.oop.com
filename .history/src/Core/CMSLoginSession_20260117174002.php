   ...
   public static function handleUserAction(array $data): array
    ...
    private static function login(array $data): array
    {
        ...
        if ($email === '' || $password === '') {
            return [
                'success'  => false,
                'redirect' => '/de/login?error=missing_fields',
            ];
        }
        ...
        if (!$user) {
            return [
                'success'  => false,
                'redirect' => '/de/login?error=user_not_found',
            ];
        }
        ...
        if (!password_verify($password, $user['password'])) {
            return [
                'success'  => false,
                'redirect' => '/de/login?error=invalid_password',
            ];
        }

        // Nur Nicht-Admins müssen verifiziert sein
        if (
            ...
            return [
                'success'  => false,
                'redirect' => '/de/login?error=not_verified',
            ];
        }

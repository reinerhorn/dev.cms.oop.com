...
final class CMSAppFrontend
{
    ...
    public static function render(
        ...
        // -------------------------------------------------
        // 4) Guards – CONTEXT-basiert (Frontend = immer public)
        // -------------------------------------------------

        // FRONTEND ist IMMER öffentlich → keine Auth- oder Permission-Prüfung
        if ($pageContext === 'frontend') {
            // bewusst leer – niemals blockieren
        } else {
        ...
        // -------------------------------------------------
        // 5) Rolle (Context-basiert, KEINE Public-Sonderlogik)
        // -------------------------------------------------

...
use CMS\Form\FormDataLoaderResolver;
use CMS\Form\Loader\EntityFormDataLoader;
use CMS\Form\Loader\TranslationFormDataLoader;
...
class CMSApp
{
    ...
    public static function init(): void
    {
        ...
        // -------------------------
        // Form Data Loader Registrierung (zentral)
        // -------------------------
        FormDataLoaderResolver::register(new EntityFormDataLoader());
        FormDataLoaderResolver::register(new TranslationFormDataLoader(self::getDb()));
    }

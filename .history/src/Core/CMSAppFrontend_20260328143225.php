...
final class CMSAppFrontend
{
    ...
    /**
     * Auto-Discovery für Form-Handler
     */
        ...
        foreach (get_declared_classes() as $class) {
            ...
            try {
                if ($class::getName() === $type) {
                    error_log("✅ FormHandler gefunden: $type → $class");
                    return $class;
                }
            } catch (\Throwable $e) {
                // ignore classes without static context
            }
        }

        error_log("❌ FormHandler NICHT gefunden: $type");
        return null;
    }

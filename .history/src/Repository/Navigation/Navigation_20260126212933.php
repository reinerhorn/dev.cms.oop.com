...
class Navigation
{
    ...
    {
        // Kein Permission → immer sichtbar
        if ($requiredPermissionId === null || $requiredPermissionId === '') {
            return true;
        }

        // Gast (keine Rolle ODER explizite Gast-Rolle)
        if ($this->roleId === null || $this->roleId === 'guest-role-000') {
            return $requiredPermissionId === 'perm-view-guest';
        }

        // Alle anderen Rollen über RoleService prüfen
